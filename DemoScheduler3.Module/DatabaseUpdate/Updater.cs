...
namespace DemoScheduler3.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater {
    ...
    public override void UpdateDatabaseAfterUpdateSchema() {
        ...
        // Create singleton Dashboard instance if it doesn't exist
        if (ObjectSpace.GetObjectsCount(typeof(Dashboard), null) == 0) {
            Dashboard dashboard = ObjectSpace.CreateObject<Dashboard>();
            dashboard.Name = "Main Dashboard";
            dashboard.Description = "Default application dashboard";
        }
